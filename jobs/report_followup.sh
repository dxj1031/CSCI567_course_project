...
ARTIFACT_ROOT="${ARTIFACT_ROOT:-$PROJECT_ROOT/outputs/artifacts/followup_experiments_$RUN_TIMESTAMP}"
...
"$ENV_PREFIX/bin/python" "$PROJECT_ROOT/scripts/compare_followup.py" \
