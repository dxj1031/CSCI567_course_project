...
ARTIFACT_ROOT="${ARTIFACT_ROOT:-$PROJECT_ROOT/outputs/artifacts/resnet50_train_time_diversification_$RUN_TIMESTAMP}"
...
"$ENV_PREFIX/bin/python" "$PROJECT_ROOT/scripts/plot_interventions.py" \
