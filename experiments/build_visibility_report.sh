...
ARTIFACT_ROOT="${ARTIFACT_ROOT:-$PROJECT_ROOT/artifacts/visibility_hypothesis_$RUN_TIMESTAMP}"
...
"$ENV_PREFIX/bin/python" "$PROJECT_ROOT/scripts/plot_visibility_results.py" \
