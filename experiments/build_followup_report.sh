...
ARTIFACT_ROOT="${ARTIFACT_ROOT:-$PROJECT_ROOT/artifacts/followup_experiments_$RUN_TIMESTAMP}"
...
"$ENV_PREFIX/bin/python" "$PROJECT_ROOT/scripts/compare_followup_experiments.py" \
