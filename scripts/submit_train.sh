...
sbatch \
  ...
  --export=ALL,PROJECT_ROOT="$PROJECT_ROOT",ENV_PREFIX="$ENV_PREFIX",DATA_ROOT="$DATA_ROOT",OUTPUT_ROOT="$OUTPUT_ROOT",CONFIG_PATH="$CONFIG_PATH",TRAIN_INTERVENTION="$TRAIN_INTERVENTION",SMOKE=0 \
